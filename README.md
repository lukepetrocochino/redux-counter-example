# Used [Redux Documentation](https://redux.js.org/tutorials/quick-start) and [This YouTube Tutorial](https://www.youtube.com/watch?v=CVpUuw9XSjY&ab_channel=DevEd) for simplicity
